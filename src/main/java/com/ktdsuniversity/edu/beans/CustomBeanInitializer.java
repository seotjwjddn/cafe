...
public class CustomBeanInitializer {
	 ...
	 * @return Container에 적재하도록 하는 Annotation입니다.
	 * 
	...
	public FileHandler fileHandler() {
		...
		fileHandler.setEnableOnfuscation(enableObfuscation);
		fileHandler.setEnableOnfuscationHideExt(enableObfuscationHideExt);
		return fileHandler;
	}
